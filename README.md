...
| tg_comment_url    | The GitHub API URL to post a comment to. | `false` on `pull_request` events, `true` for `push` events                                                                      | `https://api.github.com/repos/{owner}/{repo}/issues/{pr_number}/comments`                  |
